...
startdir1 = 'G:\AS-Filer\PHY\mmihovil\Shared\Isabel\temporal'; % Start folder, contains data from experiments ---------------
% startdir2 = ...
...
extraparams = {{'processing_params', processing_params_planarian},{},{}};  % pass the paulsmall extraction setting to the first start folder
% extraparams = {{},{},{}};
